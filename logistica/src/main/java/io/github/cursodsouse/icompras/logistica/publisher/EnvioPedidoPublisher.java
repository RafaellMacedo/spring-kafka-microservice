package io.github.cursodsouse.icompras.logistica.publisher;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.github.cursodsouse.icompras.logistica.model.AtualizacaoEnvioPedido;
...
public class EnvioPedidoPublisher {
    ...
    public void enviar(AtualizacaoEnvioPedido atualizacaoEnvioPedido) {
        log.info("Publicando peiddo enviado {}", atualizacaoEnvioPedido.codigo());

        try {
            var json = objectMapper.writeValueAsString(atualizacaoEnvioPedido);
            kafkaTemplate.send(topico, "dados", json);
            log.info("Publicado o peiddo enviado {}, código de rastreio: {}",
