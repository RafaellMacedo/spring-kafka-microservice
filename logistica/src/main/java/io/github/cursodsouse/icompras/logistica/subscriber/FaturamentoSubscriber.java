package io.github.cursodsouse.icompras.logistica.subscriber;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.github.cursodsouse.icompras.logistica.service.EnvioPedidoService;
import io.github.cursodsouse.icompras.logistica.subscriber.representation.AtualizacaoFaturamentoRepresentation;
...
public class FaturamentoSubscriber {
    ...
    public void listen(String json) {
        ...
        try {
            ...
            log.error("Erro ao preparar o pedido para envio", e);
        }
    }
